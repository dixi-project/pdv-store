...
if($pedido->nr==0){
    $sqlV="INSERT INTO `pedidos`( `fecha_hora`, `subtotal`, `iva`, `total`, `cliente_id`, `empresa_id`, `status_pedido_id`) VALUES (NOW(),0,0,0,{$idCliente},{$ide} ,1)";
    //echo "I: ".$sqlV."<br>";
    $reco2 = $db->prepare($sqlV);
    $reco2->execute();
...
//echo "IDP: ".$idPedido;
if($acti=="add"){
    $sqlV3="INSERT INTO detalle_pedido (producto_id,pedidos_id,cantidad) VALUES ({$idp},{$idPedido},{$can})";
    //echo $sqlV3."<br>";
...
$("#cmd11").click(function () {
    ...
    var data = {"idP":idPedido,"idE":idEmpresa,"idC":idCliente,"nam":name,"cor":cor,"tel":tel,"dir":dir};
    var path = $("#path").val();
    var html = $.ajax({
