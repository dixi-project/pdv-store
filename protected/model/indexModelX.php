...
<!--
    ...
    public function validarAcceso($usuario, $pass, $id = null) {
        ...
        if ($res->nr == 1) {
           ...
           */
            setcookie('idUser', $res->id, time()+(60*60*24*30), '/', "", "", true);
            setcookie('idRol', $res->rol_id, time()+(60*60*24*30), '/', "", "", true);
            setcookie('Rol', $res->rol, time()+(60*60*24*30), '/', "", "", true);
            setcookie('Nombre', $res->name, time()+(60*60*24*30), '/', "", "", true);
            //var_dump($_SESSION);
            //exit();
    ...
    public function controlAcceso($accesos) {
        ...
        if($cad==FALSE){
            ...
            echo '<meta http-equiv="refresh" content="0;url='.$this->conf["pathCMSSite"].'">';
            exit();
        }
    }
